...
export class CharleyByrneComPipelineStack extends Stack {
    constructor(scope: Construct, id: string, props: StackProps) {
        ...
        const repos = {
            cicd: CodePipelineSource.gitHub(`${Config.git.user}/${Config.git.ci.repo}`, Config.git.ci.branch),
            application: CodePipelineSource.gitHub(`${Config.git.user}/${Config.git.app.repo}`, Config.git.app.branch),
        };
        ...
        invalidation.addToRolePolicy(
            new PolicyStatement({
                ...
                resources: [`arn:aws:cloudfront::${this.account}:distribution/${stacks.distro.cloudfront.distributionId}`],
            })
        );
