...
import { CodePipelineActionFactoryResult, ICodePipelineActionFactory, ProduceActionOptions, Step } from "aws-cdk-lib/pipelines";

export class S3DeploymentStep extends Step implements ICodePipelineActionFactory {
